...
# Place ssh keys
openssl aes-256-cbc -K $encrypted_9395ba38d102_key -iv $encrypted_9395ba38d102_iv -in deploy/webdeploy.enc -out ~/.ssh/id_rsa -d
cp deploy/webdeploy.pub ~/.ssh/id_rsa.pub
